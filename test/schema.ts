...
const isValidSpace = snapshot.utils.validateSchema(snapshot.schemas.space, space);
console.log('Space', isValidSpace);

const isValidProposal = snapshot.utils.validateSchema(snapshot.schemas.proposal, proposal);
